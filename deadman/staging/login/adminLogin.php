    ...
    <div>
        <div class="card align-middle" style="width:20rem; border-radius:20px; margin:auto; margin-top:100px; background-color: whitesmoke">
            <div class="card-title" style="margin-top:30px;">
                <h2 class="card-title text-center" style="color:black;">Admin Page</h2>
            </div>
            <div class="card-body">
                <form class="form-signin" action="./adminLoginAction.php" method="POST" >
                    <input type="text" id="uid" class="form-control" placeholder="ID" required autofocus name="admin_id" autocomplete="off"><BR>
                    <input type="password" id="upw" class="form-control" placeholder="Password" required name="admin_pw" autocomplete="off"><br>
                    <input type="hidden" name="gubun" value="admin">
